...
# git pull origin main - this command doesnt work
# have no idea how to comment the two branches, dont know how to pull
#git checkout -b %anyName% - this command will clone a branch and switch to that new branch
